      ...
      <div className="container max-w-xl mx-auto py-12">
        <header className="mb-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            This demo will capture a current/new patient information such as name, phone number, reason for visit, and a preferred time to call back. (For demo purposes, the call back will be immediate) <br>Once the website visitor clicks on "Request AI Call Back", they will receive a call from the AI Receptionist to help answer their quesitons or address their needs (which can be customized and contained)
          </p>
        </header>
